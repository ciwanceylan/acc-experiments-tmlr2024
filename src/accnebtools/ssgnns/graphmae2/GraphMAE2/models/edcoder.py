...
from .gat import GAT
from .dirgat import DirGAT
from .graphsage import GraphSAGE
from .dirgraphsage import DirGraphSAGE

from .loss_func import sce_loss


def setup_module(directed, m_type, enc_dec, in_dim, num_hidden, out_dim, num_layers, dropout, activation, residual, norm, nhead, nhead_out, attn_drop, negative_slope=0.2, concat_out=True, **kwargs) -> nn.Module:
    ...
    elif m_type in ("graphsage", "gs", "sage"):
        if directed:
            mod = DirGraphSAGE(
                in_dim=in_dim,
                num_hidden=num_hidden,
