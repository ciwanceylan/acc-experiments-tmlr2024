...
from torch_geometric.nn import BatchNorm, GCNConv, LayerNorm, SAGEConv, Sequential, DirGNNConv


class GCN(nn.Module):
    def __init__(self, layer_sizes, directed: bool, batchnorm=False, batchnorm_mm=0.99, layernorm=False, weight_standardization=False):
        super().__init__()
