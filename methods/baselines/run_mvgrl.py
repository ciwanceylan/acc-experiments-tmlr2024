...
import accnebtools.ssgnns.mvgrl.trainutils as mvgrl
...
def get_trainer(graph: dgraphs.SimpleGraph, args, use_cpu: bool):
    ...
    model_trainer = mvgrl.MVGRLTrainer(
...
def main():
    name = "mvgrl"
    parser = parsing.make_parser(f"{METHOD_DIR}/config.yml", 'mvgrl')
