...
python experiments/graph_alignment.py --dataset ppi --methods acc_ga_steps_and_dims --undirected 1 --seed 23423 --timeout 3600 --noise-p 0.15 --pp-mode whiten --num-reps 5
...
python experiments/node_classification.py --dataset chameleon --methods acc_nc_steps_and_dims --undirected 0 --weighted 0 --node-attributed 1 --seed 89932 --timeout 3600 --pp-mode standardize --num-reps 1 --clf log_reg_sgd
python experiments/node_classification.py --dataset squirrel --methods acc_nc_steps_and_dims --undirected 0 --weighted 0 --node-attributed 1 --seed 89932 --timeout 3600 --pp-mode standardize --num-reps 1 --clf log_reg_sgd
...
python experiments/graph_alignment.py --dataset ppi --methods sgcn_steps --undirected 1 --seed 23423 --timeout 3600 --noise-p 0.15 --pp-mode whiten --num-reps 5
...
python experiments/node_classification.py --dataset chameleon --methods sgcn_steps --undirected 0 --weighted 0 --node-attributed 1 --seed 89932 --timeout 3600 --pp-mode standardize --num-reps 1 --clf log_reg_sgd
python experiments/node_classification.py --dataset squirrel --methods sgcn_steps --undirected 0 --weighted 0 --node-attributed 1 --seed 89932 --timeout 3600 --pp-mode standardize --num-reps 1 --clf log_reg_sgd
