...
python experiments/graph_alignment_per_node_analysis.py --dataset ppi --undirected 1 --methods detailed_ga_analysis --noise-p 0.15 --pp-mode none::whiten --dims 512
