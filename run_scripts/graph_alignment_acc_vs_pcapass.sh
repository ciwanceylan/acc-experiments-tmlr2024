...
python experiments/graph_alignment.py --dataset ppi --methods acc_vs_pcapass_k4_k10 --undirected 1 --seed 23423 --timeout 3600 --noise-p 0.15 --pp-mode none::whiten --num-reps 5 --dims 512
